...
<section class="section">
  <div class="row">
    <div>
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Data DOC Baru</h5>

          <!-- General Form Elements -->
          <form action="<?=base_url()?>/doc/simpanData" method="POST" enctype="multipart/form-data">
            <div class="row mb-3">
              <label for="inputText" class="col-sm-2 col-form-label">Jenis DOC</label>
              <div class="col-sm-10">
                <input name="jenis_doc" type="text" class="form-control">
              </div>
            </div>
            <div class="row mb-3">
              <label for="inputText" class="col-sm-2 col-form-label">Keterangan DOC</label>
              <div class="col-sm-10">
                <input name="keterangan_doc" type="text" class="form-control">
              </div>
            </div>
