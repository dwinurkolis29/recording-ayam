      ...
      <div class="card">
        <div class="card-body">
          ...
          <?php foreach ($periode as $key => $value): ?>
            <?php endforeach; ?>
            <a href="<?=base_url()?>/periode/inputDataPeriode/<?=$value->id_kandang?>" class="btn btn-primary btn-icon-split btn-sm float-right">
          ...
          <table id="tabelUser" class="table table-bordered">
            ...
            <?php foreach ($periode as $key => $value): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?=base_url()?>/recording/recording/<?=$value->id_periode?>" class="btn btn-primary"><i class="bi bi-eye"></i></a>
                            </td>
                        </tr>
            <?php $no++; ?>
            <?php endforeach; ?>
          ...
          <br><a href="<?=base_url()?>/peternak/pilihan" class="btn btn-warning">Kembali</a>
                    <script>
