...
<main id="main" class="main">
  ...
  <section class="section">
    <div class="row">
      ...
      <?php if (session()->has('successURecord')) : ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
          <i class="bi bi-check-circle me-1"></i>
          <?php echo session('successURecord'); ?>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <br><a href="<?= base_url() ?>/periode/recordingP/<?= $value->id_kandang ?>" class="btn btn-warning">Kembali</a>
