          ...
          <table id="tabelRecord" class="table table-bordered">
            <thead>
              <tr>
                ...
                <th style="text-align:center;" scope="col">Terima Pakan</th>
                <th style="text-align:center;" scope="col">Habis Pakan</th>
                <th style="text-align:center;" scope="col">Retur Pakan</th>
                <th style="text-align:center;" scope="col">Mati Ayam</th>
                <th style="text-align:center;" scope="col">Berat Ayam</th>
            ...
            <?php foreach ($recording as $key => $value): ?>
                        <tr>
                            ...
                            <td style="text-align:center;" >
                                <a href="<?= base_url() ?>/recording/ubahDataPPL/<?=$value->id_recording?>" role="button" class="btn btn-warning" ><i class="bi bi-pencil-square"></i></a>
                            </td>
                            <?php endforeach; ?>
                        </tr>
            </tbody>
          ...
          <table id="tabelUser" class="table table-bordered">
            <thead>
              <tr>
                ...
                <th scope="col" class="text-center" >Sisa Ayam</th>
                <th width="60px" class="text-center">FCR</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <?php foreach ($fcr3 as $key => $value): ?>
                 <?php if (!is_null($value->fcr_ayam)): ?>
                <td class="text-center">3</td>
                <td class="text-center"><?=$value->habis_pakan?></td>
                <td class="text-center"><?=$value->sisa_ayam?></td>
                <td class="text-center"><?=$value->fcr_ayam?></td>
                 <?php endif; ?>
                <?php endforeach; ?>
              </tr>
              <tr>
                <?php foreach ($fcr7 as $key => $value): ?>
                 <?php if (!is_null($value->fcr_ayam)): ?>
              ...
              <?php foreach ($fcr10 as $key => $value): ?>
                <?php if (!is_null($value->fcr_ayam)): ?>
              <tr>
              ...
              <tr>
                <?php foreach ($fcr14 as $key => $value): ?>
                  <?php if (!is_null($value->fcr_ayam)): ?>
              ...
              <tr>
                <?php foreach ($fcr21 as $key => $value): ?>
                  <?php if (!is_null($value->fcr_ayam)): ?>
              ...
              <tr>
                <?php foreach ($fcr24 as $key => $value): ?>
                  <?php if (!is_null($value->fcr_ayam)): ?>
              ...
              <tr>
                <?php foreach ($fcr28 as $key => $value): ?>
                  <?php if (!is_null($value->fcr_ayam)): ?>
              ...
              <tr>
                <?php foreach ($fcr31 as $key => $value): ?>
                  <?php if (!is_null($value->fcr_ayam)): ?>
              ...
              <tr>
                <?php foreach ($fcr35 as $key => $value): ?>
                  <?php if (!is_null($value->fcr_ayam)): ?>
...
<!-- end frc ayam -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <br><a href="<?=base_url()?>/periode/recordingPPL/<?=$value->id_kandang?>" class="btn btn-warning">Kembali</a>
