...
<div class="pagetitle">
  <h1>Formulir Penambahan Data Peternak</h1>
  <nav>
    <ol class="breadcrumb">
...
<section class="section">
  <div class="row">
    <div>
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Data Peternak Baru</h5>

          <!-- General Form Elements -->
          <form action="<?=base_url()?>/peternak/simpanData" method="POST" enctype="multipart/form-data">
                <div class="row mb-3">
            ...
            <div class="row mb-3">
              <label for="inputNumber" class="col-sm-2 col-form-label">Nomor Induk Kependudukan</label>
              <div class="col-sm-10">
                <input name="nik_p" type="number" class="form-control" maxlength="16" required>
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input name="nama_p" type="text" class="form-control" required>
              </div>
            </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="tgLahir_p" type="date" class="form-control">
                  </div>
                </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input name="alamat_p" type="text" class="form-control">
              </div>
            </div>

            <div class="row mb-3">
              <label for="inputText" class="col-sm-2 col-form-label">Pilih File</label>
              <div class="col-sm-10">
                <input name="gambar_p" type="file" class="form-control">
              </div>
            </div>
