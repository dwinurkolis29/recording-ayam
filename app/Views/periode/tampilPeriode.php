...
<?php if (session()->has('successIPer')): ?>
              <div class="alert alert-success alert-dismissible fade show" role="alert">
                <i class="bi bi-check-circle me-1"></i>
                <?php echo session('successIPer'); ?>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
<?php endif; ?>
<?php if (session()->has('successUPer')): ?>
              <div class="alert alert-success alert-dismissible fade show" role="alert">
                <i class="bi bi-check-circle me-1"></i>
                <?php echo session('successUPer'); ?>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
<?php endif; ?>
...
<!--batas-->
      <div class="card">
        <div class="card-body">
          ...
          <div>
            <a href="<?=base_url()?>/periode/inputData" class="btn btn-primary btn-icon-split btn-sm float-right">
          ...
          <table id="tabelUser" class="table table-bordered">
            ...
            <?php foreach ($periode as $key => $value): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url() ?>/periode/ubahData/<?=$value->id_periode?>" role="button" class="btn btn-warning" ><i class="bi bi-pencil-square"></i></a>
                                <a href="#" onclick="confirmDelete('<?= base_url() ?>/periode/hapusData/<?=$value->id_periode?>')"  role="button" class="btn btn-danger" ><i class="bi bi-trash3"></i></a>
                            </td>
                        </tr>
            <?php $no++;?>
            <?php endforeach; ?>
