...
<div class="pagetitle">
  <h1>Formulir Perubahan Data Akun</h1>
  <nav>
    <ol class="breadcrumb">
    ...
    <div>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="<?=base_url()?>/user/simpanUbahData/<?= $id_user?>" method="POST" enctype="multipart/form-data">
            <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select name="level" id="level" class="form-select" >
                      <option id="level" selected><?= $level?></option>
