...
<div class="pagetitle">
  <h1>Formulir Perubahan Data PPL</h1>
  <nav>
    <ol class="breadcrumb">
...
<section class="section">
  <div class="row">
    <div>
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Ubah Data PPL</h5>

          <!-- General Form Elements -->
          <form action="<?=base_url()?>/ppl/simpanUbahData/<?= $id_ppl?>" method="POST" enctype="multipart/form-data">
